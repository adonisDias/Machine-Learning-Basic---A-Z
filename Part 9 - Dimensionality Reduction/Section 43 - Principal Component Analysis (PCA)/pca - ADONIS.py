# -*- coding: utf-8 -*-
"""
Created on Tue Jul 16 07:00:08 2019
...
# nós criaremos um vector para visualizar a variância acumulada de todos os principal components antes de especificá-los no parâmetro n_components
# depois de criado o vetor de variance, nós observamos que os dois primeiros components possuíam a maior variance e por isso deixamos o parâmetro como 2
