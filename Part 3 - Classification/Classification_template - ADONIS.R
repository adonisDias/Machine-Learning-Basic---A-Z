...
# Encoding the target feature (categorial variable) as factor, isso é necessário para resvolver a questão do erro factor(0). (the terms 'category' and 'enumerated type' are also used for factors).
