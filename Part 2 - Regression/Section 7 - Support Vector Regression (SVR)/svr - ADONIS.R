...
regressor = svm(formula = Salary ~ .,
                data = dataset,
                type = 'eps-regression') #aqui selecionamos o tipo da SVM, para classificação devemos escolher os outros tipos descritos na especificação da biblioteca, para regressão é este.
